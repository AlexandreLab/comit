...
| [18_mvp_feature_prioritisation.md](18_mvp_feature_prioritisation.md) | **MVP feature prioritisation.** Seventy-five features sorted Must / Should / Could / Won't with spec anchor, dependency and verifying test per row; milestones M0–M6 with entry, scope, exit gate and verification, M4 being the MVP exit; the nine review decisions of 2026-09-08; open calls and the spec inconsistencies met while writing |
