...
| [2026-08-28-carb3-site-energy-system-data-migration.md](../specs/2026-08-28-carb3-site-energy-system-data-migration.md) | **The data work.** Twenty-five items in five ordered groups covering the 397-row technology collapse, the `technology_category` split, the missing decarbonisation-option join, the hybrid-unit set, and the inputs the model does not yet have |
