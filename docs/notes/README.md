...
| [20_reference_data_open_questions.md](20_reference_data_open_questions.md) | **The reference-data build's open questions.** Forty-two questions the eight research lanes could not settle, grouped by what has to change to answer them: the spec, the carrier set, the heat bands, the units, the register |
