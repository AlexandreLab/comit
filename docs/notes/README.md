...
| Doc | Topic |
|-----|-------|
| [2026-08-28-carb3-site-energy-system-implementation.md](../specs/2026-08-28-carb3-site-energy-system-implementation.md) | **The v2 specification itself — partial.** §1 scope and conventions, §2 system overview, §3 data model (9 entities: carrier, unit, unit_input_output, unit_eligibility, unit_bill_of_materials, archetype_coefficient, process_duty, premise_connection, scenario_parameters), and §5 the optimisation model (C1–C12, including the carrier balance and the heat-grade cascade). §4 and §6–§13 are not yet written and are named against their tasks |
