...
| Carriers | `carrier` | §3.4 | — | `carrier_name`, `carrier_kind`, `is_gradeable`, `grade_rank`, `grade_label`, `is_indirect`, `biogenic_fraction`, `carbon_charge`, `denominator_kind`, `may_dispose` |
